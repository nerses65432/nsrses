...
const MacBookAirThreePage = () => {
  ...
  return (
    <>
      <div className="bg-indigo-100 flex flex-col font-playfairdisplay items-center justify-start mx-auto w-full">
        ...
        <Button
          className="common-pointer bg-gray-50 border-[5px] border-black-900 border-solid cursor-pointer font-semibold min-w-[139px] mt-[5px] py-3 rounded-[17px] text-base text-black-900 text-center"
        ...
        <div className="flex h-[82px] justify-end md:px-5 relative w-full">
          <div className="flex flex-col h-full items-center justify-start mb-[13px] ml-auto mr-[522px] mt-auto pr-0.5 pt-0.5">
            <Text
              className="mt-1.5 text-base text-black-900"
              size="txtPlayfairDisplayRomanRegular16"
            >
              study hard. achieve big.
            </Text>
          </div>
          <div className="absolute bg-black-900 flex flex-col h-full inset-[0] items-center justify-center m-auto pt-[18px] px-[18px] w-full">
            <Img
