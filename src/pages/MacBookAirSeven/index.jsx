    ...
    <>
      <div className="bg-indigo-100 flex flex-col font-playfairdisplay items-center justify-end mx-auto w-full">
        ...
        <div className="flex flex-col mt-[89px] md:px-5 relative w-[43%] sm:w-full">
          ...
          <div className="flex flex-row items-center justify-center ml-auto mr-[69px] mt-[-32.01px] w-[63%] z-[1]">
            <div className="h-[171px] relative w-[45%]">
              <div className="absolute bg-indigo-50 h-[84px] inset-[0] justify-center m-auto rounded-[9px] shadow-bs1 w-full"></div>
              <Text
            ...
            <div className="h-[171px] ml-[3px] relative w-[56%]">
              <div className="absolute flex flex-col h-max inset-[0] items-center justify-center m-auto w-[99%]">
                <div className="flex flex-row items-center justify-evenly w-full">
                  <Text
                    className="shadow-bs1 md:text-5xl text-9xl text-black-900"
                    size="txtPlayfairDisplayRomanRegular128"
                  >
                    :
                  </Text>
                  <div className="bg-indigo-50 h-[86px] my-[42px] rounded-[9px] shadow-bs1 w-[82%]"></div>
                </div>
              </div>
              <Text
                className="absolute h-full inset-y-[0] my-auto right-[0] shadow-bs1 md:text-5xl text-9xl text-black-900"
                size="txtPlayfairDisplayRomanRegular128"
              >
                00
              </Text>
...
export default MacBookAirSevenPage;
